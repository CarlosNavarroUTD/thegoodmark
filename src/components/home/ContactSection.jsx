            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="https://wa.me/5216181032038" className="text-gray-600 hover:text-[#165e9d] transition-colors">
                    +52 618 103 2038
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="mailto:thegoodmark1@gmail.com" className="text-gray-600 hover:text-[#165e9d] transition-colors">
